...
import ShopWomenFilter from './ShopWomenFilter';
    ...
    return (
        <div className=' mb-20'>
            ...
            <div className=' mx-[70px] mt-10'>
                ...
                <ShopWomenFilter ShopWomen={ShopWomen} activeFabric={activeFabric} setActiveFabric={setActiveFabric} ></ShopWomenFilter>
                <div className="divider w-full mb-10"></div>
                <div className=" pl-5 grid grid-cols-4 gap-16">
                    {
                        activeFabric === '' && filteredFroduct.length <= 0 ? (
                            ShopWomen && ShopWomen.map(item =>
