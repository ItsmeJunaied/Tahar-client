        ...
        <div>
            ...
            <div className="px-4 pt-6">
                <div className="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
                    ...
                    <div className="p-4 bg-white border  200 rounded-lg shadow-sm 2xl:col-span-2    sm:p-6   ">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex-shrink-0">
                                <span className="text-xl font-bold leading-none   sm:text-2xl   text-black">$45,385</span>
                                <h3 className="text-base font-light     400">Sales this week</h3>
                            </div>
                        ...
                        <div className="flex items-center justify-between pt-3 mt-4 border-t  200 sm:pt-6   ">
                            <div>
                                <button className="inline-flex items-center p-2 text-sm font-medium text-center   rounded-lg     400  hover: text-black" type="button" data-dropdown-toggle="weekly-sales-dropdown">Last 7 days <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></button>
                                 
                                <div className="z-50 hidden my-4 text-base list-none bg-white divide-y  100 rounded shadow     " id="weekly-sales-dropdown">
                                    <div className="px-4 py-3" role="none">
                                        <p className="text-sm font-medium   truncate   text-black" role="none">
                                            Sep 16, 2021 - Sep 22, 2021
                                        </p>
                                    </div>
                                    <ul className="py-1" role="none">
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm  700  100   400   600  hover: text-black" role="menuitem">Yesterday</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm  700  100   400   600  hover: text-black" role="menuitem">Today</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm  700  100   400   600  hover: text-black" role="menuitem">Last 7 days</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm  700  100   400   600  hover: text-black" role="menuitem">Last 30 days</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm  700  100   400   600  hover: text-black" role="menuitem">Last 90 days</a>
                                        </li>
                                    </ul>
                                    <div className="py-1" role="none">
                                        <a href="#" className="block px-4 py-2 text-sm  700  100   400   600  hover: text-black" role="menuitem">Custom...</a>
                                    </div>
                                </div>
                            </div>
                            <div className="flex-shrink-0">
                                <a href="#" className="inline-flex items-center p-2 text-xs font-medium uppercase rounded-lg text-primary-700 sm:text-sm  100  text-primary-500   700">
                                    Sales Report
                    ...
                    <div className="p-4 bg-white border  200 rounded-lg shadow-sm    sm:p-6   ">
                        <h3 className="flex items-center mb-4 text-lg font-semibold     text-black">Statistics this month
                            <button data-popover-target="popover-description" data-popover-placement="bottom-end" type="button"><svg className="w-4 h-4 ml-2  400  " aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd"></path></svg><span className="sr-only">Show information</span></button>
                        </h3>
                        <div data-popover id="popover-description" role="tooltip" className="absolute z-10 invisible inline-block text-sm font-light   transition-opacity duration-300 bg-white border  200 rounded-lg shadow-sm opacity-0 w-72      600   400">
                            <div className="p-3 space-y-2">
                                ...
                                <a href="#" className="flex items-center font-medium text-primary-600  text-primary-500  hover:text-primary-600 hover:text-primary-700">Read more <svg className="w-4 h-4 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg></a>
                            </div>
                            <div data-popper-arrow></div>
                        </div>
                        <div className="sm:hidden">
                            <label htmlFor="tabs" className="sr-only">Select tab</label>
                            <select id="tabs" className=" 50 border-0 border-b  200   text-sm rounded-t-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5     600  placeholder-gray-400   text-black  focus:ring-primary-500  focus:border-primary-500">
                                <option>Statistics</option>
                                <option>Services</option>
                                <option>FAQ</option>
                            </select>
                        </div>
                        <ul className="hidden text-sm font-medium text-center   divide-x  200 rounded-lg sm:flex      400" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
                            <li className="w-full">
                                <button id="faq-tab" data-tabs-target="#faq" type="button" role="tab" aria-controls="faq" aria-selected="true" className="inline-block w-full p-4 rounded-tl-lg  50  100 focus:outline-none     600">Top products</button>
                            </li>
                            <li className="w-full">
                                <button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about" aria-selected="false" className="inline-block w-full p-4 rounded-tr-lg  50  100 focus:outline-none     600">Top Customers</button>
                            </li>
                        </ul>
                        <div id="fullWidthTabContent" className="border-t  200   600">
                            <div className="hidden pt-4" id="faq" role="tabpanel" aria-labelledby="faq-tab">
                                <ul role="list" className="divide-y  200   700">
                                            ...
                                            <div className="flex items-center min-w-0">
                                                <img className="flex-shrink-0 w-10 h-10" src="/images/products/iphone.png" alt="imac image"/>
                                                    <div className="ml-3">
                                                        ...
                                                        <div className="flex items-center justify-end flex-1 text-sm    text-green-400">
                                            ...
                                            <div className="flex items-center min-w-0">
                                                <img className="flex-shrink-0 w-10 h-10" src="/images/products/watch.png" alt="watch image"/>
                                                    <div className="ml-3">
                                                        ...
                                                        <div className="flex items-center justify-end flex-1 text-sm   text-red-500">
                                                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    ...
                                    <li className="py-3 sm:py-4">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-sm   truncate   400">
                                                    email@flowbite.com
                                                </p>
                                            </div>
                                            <div className="inline-flex items-center text-base font-semibold     text-black">
                        ...
                        <div className="flex items-center justify-between pt-3 mt-5 border-t  200 sm:pt-6   ">
                            <div>
                                <button className="inline-flex items-center p-2 text-sm font-medium text-center   rounded-lg     400  hover: text-black" type="button" data-dropdown-toggle="stats-dropdown">Last 7 days <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></button>
                                 
                                <div className="z-50 hidden my-4 text-base list-none bg-white divide-y  100 rounded shadow     " id="stats-dropdown">
                                    <div className="px-4 py-3" role="none">
                                        <p className="text-sm font-medium   truncate   text-black" role="none">
                                            Sep 16, 2021 - Sep 22, 2021
                                        </p>
                ...
                <div className="grid w-full grid-cols-1 gap-4 mt-4 xl:grid-cols-2 2xl:grid-cols-3">
                    <div className="items-center justify-between p-4 bg-white border  200 rounded-lg shadow-sm sm:flex    sm:p-6   ">
                        <div className="w-full">
                            <h3 className="text-base font-normal     400">New products</h3>
                            <span className="text-2xl font-bold leading-none   sm:text-3xl   text-black">2,340</span>
                            <p className="flex items-center text-base font-normal     400">
                    ...
                    <div className="items-center justify-between p-4 bg-white border  200 rounded-lg shadow-sm sm:flex    sm:p-6   ">
                        <div className="w-full">
                            <h3 className="text-base font-normal     400">Users</h3>
                            <span className="text-2xl font-bold leading-none   sm:text-3xl   text-black">2,340</span>
                            <p className="flex items-center text-base font-normal     400">
                                <span className="flex items-center mr-1.5 text-sm    text-green-400">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <div className="p-4 bg-white border  200 rounded-lg shadow-sm    sm:p-6   ">
                        <div className="w-full">
                            <h3 className="mb-2 text-base font-normal     400">Audience by age</h3>
                            <div className="flex items-center mb-2">
                                <div className="w-16 text-sm font-medium   text-black">50+</div>
                                <div className="w-full  200 rounded-full h-2.5  ">
                                    <div className="bg-primary-600 h-2.5 rounded-full  bg-primary-500" style={{ width: '18%' }}></div>
                                </div>
                            </div>
                            <div className="flex items-center mb-2">
                                <div className="w-16 text-sm font-medium   text-black">40+</div>
                                <div className="w-full  200 rounded-full h-2.5  ">
                                    <div className="bg-primary-600 h-2.5 rounded-full  bg-primary-500" style={{width: '15%'}}></div>
                                </div>
                            </div>
                            <div className="flex items-center mb-2">
                                <div className="w-16 text-sm font-medium   text-black">30+</div>
                                <div className="w-full  200 rounded-full h-2.5  ">
                                    <div className="bg-primary-600 h-2.5 rounded-full  bg-primary-500" style={{width: '60%'}}></div>
                                </div>
                            </div>
                            <div className="flex items-center mb-2">
                                <div className="w-16 text-sm font-medium   text-black">20+</div>
                                <div className="w-full  200 rounded-full h-2.5  ">
                                    <div className="bg-primary-600 h-2.5 rounded-full  bg-primary-500" style={{width: '30%'}}></div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4">
                    <div className="p-4 mb-4 bg-white border  200 rounded-lg shadow-sm sm:p-6       xl:mb-0">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold     text-black">Smart chat</h3>
                            <a href="#" className="inline-flex items-center p-2 text-sm font-medium rounded-lg text-primary-700  100  text-primary-500   700">
                                View all
                            </a>
                        </div>
                        <form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
                            <article className="mb-5">
                                <footer className="flex items-center justify-between mb-2">
                                    <div className="flex items-center">
                                        <p className="inline-flex items-center mr-3 text-sm font-semibold     text-black"><img className="w-6 h-6 mr-2 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-2.jpg" alt="Michael Gough"/>Michael Gough</p>
                                        <p className="text-sm  600   400"><time   dateTime="2022-02-08" title="February 8th, 2022"> 01/03/2023 4:15 PM</time></p>
                                    </div>
                                    <button id="dropdownComment1Button" data-dropdown-toggle="dropdownComment1" className="inline-flex items-center p-2 text-sm font-medium text-center   bg-white rounded-lg  100 focus:ring-4 focus:outline-none  -50      700   300   -600" type="button">
                                    ...
                                    <div id="dropdownComment1" className="z-10 hidden bg-white divide-y  100 rounded shadow w-36     ">
                                        <ul className="py-1 text-sm  700   200" aria-labelledby="dropdownMenuIconHorizontalButton">
                                            <li>
                                                <a href="#"
                                                    className="block px-4 py-2  100   600  hover: text-black">Edit</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                    className="block px-4 py-2  100   600  hover: text-black">Remove</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                    className="block px-4 py-2  100   600  hover: text-black">Report</a>
                                            </li>
                                        </ul>
                                    </div>
                                </footer>
                                <p className="mb-2     text-black">
                                    Hello <a href="#" className="font-medium hover:underline text-primary-600  text-primary-500">@designteam</a> Lets schedule a kick-off meeting and workshop this week. It would be great to gather everyone involved in the design project. Let me know about your availability in the thread.
                                </p>
                                <p className="mb-3     text-black">Looking forward to it! Thanks.</p>
                                <a href="#" className="inline-flex items-center text-xs font-medium text-primary-700 sm:text-sm  text-primary-500">
                                    4 replies
                            ...
                            <article className="mb-5">
                                <footer className="flex items-center justify-between mb-2">
                                    <div className="flex items-center">
                                        <p className="inline-flex items-center mr-3 text-sm font-semibold     text-black"><img className="w-6 h-6 mr-2 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-3.jpg" alt="Bonnie avatar"/>Bonnie Green</p>
                                        <p className="text-sm  600   400"><time   dateTime="2022-02-08" title="February 8th, 2022"> 01/03/2023 4:15 PM</time></p>
                                    </div>
                                    <button id="dropdownComment2Button" data-dropdown-toggle="dropdownComment2" className="inline-flex items-center p-2 text-sm font-medium text-center   bg-white rounded-lg  100 focus:ring-4 focus:outline-none  -50      700   300   -600" type="button">
                                        <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z">
                                    ...
                                    <div id="dropdownComment2" className="z-10 hidden bg-white divide-y  100 rounded shadow w-36     ">
                                        <ul className="py-1 text-sm  700   200" aria-labelledby="dropdownMenuIconHorizontalButton">
                                            <li>
                                                <a href="#"
                                                    className="block px-4 py-2  100   600  hover: text-black">Edit</a>
                                ...
                                <p className="mb-3     text-black">Hello everyone,</p>
                                <p className="mb-2     text-black">
                                    Thank you for the workshop, it was very productive meeting. I  wait to start working on this new project with you guys. But first things first,  waiting for the offer and pitch deck from you. It would be great to get it by the end o the month.
                                </p>
                                <p className="mb-3     text-black">Cheers!</p>
                                <div className="flex items-center mb-2 space-x-2">
                                    <button type="button" className="py-1.5 px-3 inline-flex items-center rounded-lg  100  200   600  ">
                                        
                                        <span className="text-sm font-medium     400">14</span>
                                    </button>
                                    <button type="button" className="py-1.5 px-3 inline-flex items-center rounded-lg  100  200   600  ">
                                        ...
                                        <span className="text-sm font-medium     400">8</span>
                                    </button>
                                    <button type="button" className="py-1.5 px-3 inline-flex items-center rounded-lg  100  200   600  ">
                                        ...
                                        <span className="text-sm font-medium     400">3</span>
                                    </button>
                                </div>
                            </article>
                            <article className="mb-5">
                                <footer className="flex items-center justify-between mb-2">
                                    <div className="flex items-center">
                                        <p className="inline-flex items-center mr-3 text-sm font-semibold     text-black"><img className="w-6 h-6 mr-2 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="Jese avatar"/>Jese Leos</p>
                                        <p className="text-sm  600   400"><time   dateTime="2022-02-08" title="February 8th, 2022"> 01/03/2023 4:15 PM</time></p>
                                    </div>
                                    <button id="dropdownComment3Button" data-dropdown-toggle="dropdownComment3" className="inline-flex items-center p-2 text-sm font-medium text-center   bg-white rounded-lg  100 focus:ring-4 focus:outline-none  -50      700   300   -600" type="button">
                                        <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z"></path>
                                        </svg>
                                        <span className="sr-only">Comment settings</span>
                                    </button>
                                    <div id="dropdownComment3" className="z-10 hidden bg-white divide-y  100 rounded shadow w-36     ">
                                        <ul className="py-1 text-sm  700   200" aria-labelledby="dropdownMenuIconHorizontalButton">
                                            <li>
                                                <a href="#" className="block px-4 py-2  100   600  hover: text-black">Edit</a>
                                            </li>
                                            <li>
                                                <a href="#" className="block px-4 py-2  100   600  hover: text-black">Remove</a>
                                            </li>
                                            <li>
                                                <a href="#" className="block px-4 py-2  100   600  hover: text-black">Report</a>
                                            </li>
                                        </ul>
                                    </div>
                                </footer>
                                <p className="mb-2     text-black">
                                    Ok <a href="#" className="font-medium hover:underline text-primary-600  text-primary-500">@team</a>   attaching our offer and pitch deck. Take your time to review everything.   looking forward to the next steps! Thank you.
                                </p>
                                <p className="mb-3     text-black">Looking forward to it! Thanks.</p>
                                <div className="items-center 2xl:space-x-4 2xl:flex">
                                    <div className="flex items-center p-3 mb-3.5 border  200    rounded-lg">
                                        <div className="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-primary-100  bg-primary-900">
                                            <svg className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6  text-primary-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                        ...
                                        <div className="mr-4">
                                            <p className="text-sm font-semibold     text-black">flowbite_offer_ </p>
                                            <p className="text-sm     400">PDF, 2.3 MB</p>
                                        </div>
                                        <div className="flex items-center ml-auto">
                                            <button type="button" className="p-2 rounded  100">
                                                <svg className="w-5 h-5     400" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                    <path clipRule="evenodd" fillRule="evenodd" d="M12 2.25a.75.75 0 01.75.75v11.69l3.22-3.22a.75.75 0 111.06 1.06l-4.5 4.5a.75.75 0 01-1.06 0l-4.5-4.5a.75.75 0 111.06-1.06l3.22 3.22V3a.75.75 0 01.75-.75zm-9 13.5a.75.75 0 01.75.75v2.25a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5V16.5a.75.75 0 011.5 0v2.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V16.5a.75.75 0 01.75-.75z"></path>
                                                </svg>
                                                <span className="sr-only">Download</span>
                                            </button>
                                            <button type="button" className="p-2 rounded  100">
                                                <svg className="w-5 h-5     400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    ...
                                    <div className="flex items-center p-3 mb-3.5 border  200    rounded-lg">
                                        <div className="flex items-center justify-center w-10 h-10 mr-3 bg-teal-100 rounded-lg  ">
                                            <svg className="w-5 h-5 lg:w-6 lg:h-6  text-teal-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"></path>
                                            </svg>
                                        </div>
                                        <div className="mr-4">
                                            <p className="text-sm font-semibold     text-black">bergside_pitch</p>
                                            <p className="text-sm     400">PPTX, 10.1 MB</p>
                                        </div>
                                        <div className="flex items-center ml-auto">
                                            <button type="button" className="p-2 rounded  100">
                                                <svg className="w-5 h-5     400" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <article className="pl-12 mb-5">
                                <footer className="flex items-center justify-between mb-2">
                                    <div className="flex items-center">
                                        <p className="inline-flex items-center mr-3 text-sm font-semibold     text-black"><img className="w-6 h-6 mr-2 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-1.jpg" alt="Joseph avatar"/>Joseph McFallen</p>
                                        <p className="text-sm  600   400"><time   dateTime="2022-02-08" title="February 8th, 2022"> 01/03/2023 4:15 PM</time></p>
                                    </div>
                                    <button id="dropdownComment4Button" data-dropdown-toggle="dropdownComment4" className="inline-flex items-center p-2 text-sm font-medium text-center   bg-white rounded-lg  100 focus:ring-4 focus:outline-none  -50      700   300   -600" type="button">
                                        <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z"></path>
                                        </svg>
                                        <span className="sr-only">Comment settings</span>
                                    </button>
                                    <div id="dropdownComment4" className="z-10 hidden bg-white divide-y  100 rounded shadow w-36     ">
                                        <ul className="py-1 text-sm  700   200"
                                ...
                                <p className="mb-2     text-black">
                                    Hello <a href="#" className="font-medium hover:underline text-primary-600  text-primary-500">@jeseleos</a> I need some informations about flowbite react version.
                                </p>
                            </article>
                            <article className="pl-12 mb-5">
                                <footer className="flex items-center justify-between mb-2">
                                    ...
                                    <button id="dropdownComment5Button" data-dropdown-toggle="dropdownComment5" className="inline-flex items-center p-2 text-sm font-medium text-center   bg-white rounded-lg  100 focus:ring-4 focus:outline-none  -50      700   300   -600" type="button">
                                        <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z"></path>
                                        </svg>
                                        <span className="sr-only">Comment settings</span>
                                    </button>
                                    <div id="dropdownComment5" className="z-10 hidden bg-white divide-y  100 rounded shadow w-36     ">
                                        <ul className="py-1 text-sm  700   200" aria-labelledby="dropdownMenuIconHorizontalButton">
                                            <li>
                                                <a href="#" className="block px-4 py-2  100   600  hover: text-black">Edit</a>
                                            </li>
                                ...
                                <p className="mb-4     text-black">
                                    Hi <a href="#" className="font-medium hover:underline text-primary-600  text-primary-500">@josephh</a> Sure, just let me know whean you are available and we can speak.
                                </p>
                                <form>
                                    <label htmlFor="chat" className="sr-only">Your message</label>
                                    <div className="flex items-center mb-5">
                                        <textarea id="chat" rows="1" className="block mr-4 p-2.5 w-full text-sm   bg-white rounded-lg border  300 focus:ring-primary-500 focus:border-primary-500      600  placeholder-gray-400   text-black  focus:ring-primary-500  focus:border-primary-500" placeholder="Reply in thread..."></textarea>
                                        <button type="submit" className="inline-flex justify-center p-2 rounded-lg cursor-pointer text-primary-600 hover:bg-primary-100  text-primary-500   600">
                                            <svg aria-hidden="true" className="w-6 h-6 rotate-90" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z"></path></svg>
                                            <span className="sr-only">Send message</span>
                                        </button>
                                    </div>
                                </form>
                                <span className="inline-flex items-center text-xs font-medium cursor-pointer hover:underline text-primary-700 sm:text-sm  text-primary-500">
                                    Hide thread
                                    <svg className="w-5 h-5 ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <div className="w-full border  200 rounded-lg  50     600">
                                <div className="px-4 py-2 bg-white rounded-t-lg   ">
                                    <label htmlFor="comment" className="sr-only">Write your message</label>
                                    <textarea id="comment" rows="8" className="w-full px-0 text-sm   bg-white border-0    focus:ring-0   text-black  placeholder-gray-400" placeholder="Write your message" required></textarea>
                                </div>
                                <div className="flex items-center justify-between px-3 py-2 border-t   600">
                                    <button type="submit" className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center  text-black bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200  focus:ring-primary-900 hover:bg-primary-800">
                                        Send message
                                    </button>
                                    <div className="flex pl-0 space-x-1 sm:pl-2">
                                        <button type="button" className="inline-flex justify-center p-2   rounded cursor-pointer    100   400  hover: text-black   600">
                    ...
                    <div className="grid gap-4">
                        <div className="p-4 bg-white border  200 rounded-lg shadow-sm    sm:p-6   ">
                            <div className="items-center justify-between pb-4 border-b  200 sm:flex   ">
                                <div className="w-full mb-4 sm:mb-0">
                                    <h3 className="text-base font-normal     400">Sales by category</h3>
                                    <span className="text-2xl font-bold leading-none   sm:text-3xl   text-black">Desktop PC</span>
                                    <p className="flex items-center text-base font-normal     400">
                                        <span className="flex items-center mr-1.5 text-sm    text-green-400">
                                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path clipRule="evenodd" fillRule="evenodd" d="M10 17a.75.75 0 01-.75-.75V5.612L5.29 9.77a.75.75 0 01-1.08-1.04l5.25-5.5a.75.75 0 011.08 0l5.25 5.5a.75.75 0 11-1.08 1.04l-3.96-4.158V16.25A.75.75 0 0110 17z"></path>
                                ...
                                <div className="w-full max-w-lg">
                                    <div  className="grid items-center grid-cols-2 gap-4">
                                        <div className="relative">
                                            ...
                                            <input name="start" type="text" className=" 50 border  300   text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5      600  placeholder-gray-400   text-black  focus:ring-primary-500  focus:border-primary-500" placeholder="From" />
                                        </div>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                                <svg className="w-5 h-5     400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            ...
                                            <input name="end" type="text" className=" 50 border  300   text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5      600  placeholder-gray-400   text-black  focus:ring-primary-500  focus:border-primary-500" placeholder="To" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-3 mt-4 border-t  200 sm:pt-6   ">
                                <div>
                                    <button className="inline-flex items-center p-2 text-sm font-medium text-center   rounded-lg     400  hover: text-black" type="button" data-dropdown-toggle="sales-by-category-dropdown">Last 7 days <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></button>
                                    <div className="z-50 hidden my-4 text-base list-none bg-white divide-y  100 rounded shadow     " id="sales-by-category-dropdown">
                                        <div className="px-4 py-3" role="none">
                                            <p className="text-sm font-medium   truncate   text-black" role="none">
                                                Sep 16, 2021 - Sep 22, 2021
                                            </p>
                        ...
                        <div className="p-4 bg-white border  200 rounded-lg shadow-sm    sm:p-6   ">
                            <div className="flex items-center justify-between pb-4 mb-4 border-b  200   ">
                                <div>
                                    <h3 className="text-base font-normal     400">Traffic by device</h3>
                                    <span className="text-2xl font-bold leading-none   sm:text-3xl   text-black">Desktop</span>
                                </div>
                                <a href="#" className="inline-flex items-center p-2 text-xs font-medium uppercase rounded-lg text-primary-700 sm:text-sm  100  text-primary-500   700">
                                    Full report
                                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
                            ...
                            <div className="flex items-center justify-between pt-4 lg:justify-evenly sm:pt-6">
                                <div>
                                    <svg className="w-8 h-8 mb-1     400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    ...
                                    <h3 className="    400">Desktop</h3>
                                    <h4 className="text-xl font-bold   text-black">
                                        234k
                                    </h4>
                                    <p className="flex items-center text-sm     400">
                                        <span className="flex items-center mr-1.5 text-sm    text-green-400">
                                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path clipRule="evenodd" fillRule="evenodd" d="M10 17a.75.75 0 01-.75-.75V5.612L5.29 9.77a.75.75 0 01-1.08-1.04l5.25-5.5a.75.75 0 011.08 0l5.25 5.5a.75.75 0 11-1.08 1.04l-3.96-4.158V16.25A.75.75 0 0110 17z"></path>
                                            </svg>
                                ...
                                <div>
                                    ...
                                    <h3 className="    400">Phone</h3>
                                    <h4 className="text-xl font-bold   text-black">
                                        94k
                                    </h4>
                                    <p className="flex items-center text-sm     400">
                                        <span className="flex items-center mr-1.5 text-sm   text-red-500">
                                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                <path clipRule="evenodd" fillRule="evenodd" d="M10 3a.75.75 0 01.75.75v10.638l3.96-4.158a.75.75 0 111.08 1.04l-5.25 5.5a.75.75 0 01-1.08 0l-5.25-5.5a.75.75 0 111.08-1.04l3.96 4.158V3.75A.75.75 0 0110 3z"></path>
                                            </svg>
                                            1%
                ...
                <div className="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4">
                    <div className="p-4 mb-4 bg-white border  200 rounded-lg shadow-sm    sm:p-6    xl:mb-0">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold     text-black">Latest Activity</h3>
                            <a href="#" className="inline-flex items-center p-2 text-sm font-medium rounded-lg text-primary-700  100  text-primary-500   700">
                                View all
                            </a>
                        </div>
                        <ol className="relative border-l  200   ">
                            <li className="mb-10 ml-4">
                                <div className="absolute w-3 h-3  200 rounded-full mt-1.5 -left-1.5 border border-white   800  "></div>
                                <time className="mb-1 text-sm font-normal leading-none  400   ">April 2023</time>
                                <h3 className="text-lg font-semibold     text-black">Application UI design in Figma</h3>
                                <p className="mb-4 text-base font-normal     400">Get access to over 20+ pages including a dashboard layout, charts, kanban board, calendar, and pre-order E-commerce & Marketing pages.</p>
                                <a href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium   bg-white border  200 rounded-lg  100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:outline-none  -200 focus:text-primary-700      400   600  hover: text-black   700   -700">Learn more <svg className="w-3 h-3 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg></a>
                            </li>
                            <li className="mb-10 ml-4">
                                <div className="absolute w-3 h-3  200 rounded-full mt-1.5 -left-1.5 border border-white   800  "></div>
                                <time className="mb-1 text-sm font-normal leading-none  400   ">March 2023</time>
                                <h3 className="text-lg font-semibold     text-black">Marketing UI code in Flowbite</h3>
                                <p className="mb-4 text-base font-normal     400">Get started with dozens of web components and interactive elements built on top of Tailwind CSS.</p>
                                <a href="https://flowbite.com/blocks/" className="inline-flex items-center text-xs font-medium hover:underline text-primary-700 sm:text-sm  text-primary-500">
                            ...
                            <li className="mb-10 ml-4">
                                <div className="absolute w-3 h-3  200 rounded-full mt-1.5 -left-1.5 border border-white   800  "></div>
                                <time className="mb-1 text-sm font-normal leading-none  400   ">February 2023</time>
                                <h3 className="text-lg font-semibold     text-black">Marketing UI design in Figma</h3>
                                <p className="text-base font-normal     400">Get started with dozens of web components and interactive elements built on top of Tailwind CSS.</p>
                            </li>
                        </ol>
                    </div>
                    <div className="p-4 bg-white border  200 rounded-lg shadow-sm    sm:p-6   ">
                        <div id="carousel" className="relative" data-carousel="">
                            <div className="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                                <div className="hidden duration-700 ease-in-out bg-white   " data-carousel-item>
                                    ...
                                    <h3 className="mb-4 text-2xl font-medium     text-black">You are going to grow by 44% next year</h3>
                                    <p className="mb-4     400">Get started with a free and open-source admin dashboard layout built with Tailwind CSS and Flowbite featuring charts, widgets, CRUD layouts, authentication pages, and more</p>
                                    <p className="mb-2 text-lg font-medium     text-black">Key Takeaways:</p>
                                    <ul className="pl-4 mb-4 space-y-3   list-disc   400">
                                    ...
                                    <a href="#" className="inline-flex items-center p-2 font-medium rounded-lg text-primary-700  100  text-primary-500   700">
                                        Get me there
                                        <svg className="w-5 h-5 ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                ...
                                <div className="hidden duration-700 ease-in-out bg-white   " data-carousel-item>
                                    ...
                                    <p className="mb-4     400">Marketing, sales & business growth for small business. Improve your marketing & promotion results - and grow your sales!</p>
                                    <p className="mb-4 text-lg font-medium     text-black">What youll learn:</p>
                                    <ul role="list" className="pl-2 mb-4 space-y-3   list-disc   400">
                                        <li className="flex space-x-2">
                                            <svg className="flex-shrink-0 w-5 h-5     400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                ...
                                <div className="hidden duration-700 ease-in-out bg-white   " data-carousel-item>
                                    ...
                                    <h3 className="mb-4 text-2xl font-medium     text-black">Go next level with Flowbite</h3>
                                    <p className="    400">Deliver great service experiences fast - without the complexity of traditional ITSM solutions.Accelerate critical development work, eliminate toil, and deploy changes with ease.</p>
                                    <ul role="list" className="pl-2 my-5 mb-4 space-y-3   list-disc   400">
                                    ...
                                    <button type="button" className="inline-flex items-center px-3 py-2 text-sm font-medium   bg-white border  200 rounded-lg focus:outline-none  100 hover:text-primary-700 focus:z-10 focus:ring-4  -200   -700      400   600  hover: text-black   700">
                                        View more
                                        <svg className="w-5 h-5 ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path clipRule="evenodd" fillRule="evenodd" d="M2 10a.75.75 0 01.75-.75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 0 11-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z"></path>
                                        </svg>
                ...
                <div className="p-4 bg-white border  200 rounded-lg shadow-sm    sm:p-6   ">
                    <div className="items-center justify-between lg:flex">
                        <div className="mb-4 lg:mb-0">
                            <h3 className="mb-2 text-xl font-bold     text-black">Transactions</h3>
                            <span className="text-base font-normal     400">This is a list of latest transactions</span>
                        </div>
                        <div className="items-center sm:flex">
                            <div className="flex items-center">
                                <button id="dropdownDefault" data-dropdown-toggle="dropdown"
                                    className="mb-4 sm:mb-0 mr-4 inline-flex items-center   bg-white border  300 focus:outline-none  100 focus:ring-4  -200 font-medium rounded-lg text-sm px-4 py-2.5      text-black   600   700  hover: 600   -700"
                                    type="button">
                                    Filter by status
                                ...
                                <div id="dropdown" className="z-10 hidden w-56 p-3 bg-white rounded-lg shadow  ">
                                    ...
                                    <ul className="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                                        <li className="flex items-center">
                                            <input id="apple" type="checkbox" value="" className="w-4 h-4  100  300 rounded text-primary-600 focus:ring-primary-500  focus:ring-primary-600  ring-offset-gray-700 focus:ring-2   600   500" />

                                            <label htmlFor="apple" className="ml-2 text-sm font-medium     100">
                                                Completed (56)
                                            </label>
                                        </li>

                                        <li className="flex items-center">
                                            <input id="fitbit" type="checkbox" value="" checked className="w-4 h-4  100  300 rounded text-primary-600 focus:ring-primary-500  focus:ring-primary-600  ring-offset-gray-700 focus:ring-2   600   500" />

                                            <label htmlFor="fitbit" className="ml-2 text-sm font-medium     100">
                                                Cancelled (56)
                                            </label>
                                        </li>

                                        <li className="flex items-center">
                                            <input id="dell" type="checkbox" value="" className="w-4 h-4  100  300 rounded text-primary-600 focus:ring-primary-500  focus:ring-primary-600  ring-offset-gray-700 focus:ring-2   600   500" />

                                            <label htmlFor="dell" className="ml-2 text-sm font-medium     100">
                                                In progress (56)
                                            </label>
                                        </li>

                                        <li className="flex items-center">
                                            <input id="asus" type="checkbox" value="" checked className="w-4 h-4  100  300 rounded text-primary-600 focus:ring-primary-500  focus:ring-primary-600  ring-offset-gray-700 focus:ring-2   600   500" />

                                            <label htmlFor="asus" className="ml-2 text-sm font-medium     100">
                                                In review (97)
                                            </label>
                                        </li>
                                    </ul>
                            ...
                            <div className="inline-block min-w-full align-middle">
                                <div className="overflow-hidden shadow sm:rounded-lg">
                                    <table className="min-w-full divide-y  200   ">
                                        <thead className=" 50  ">
                                            <tr>
                                                <th scope="col" className="p-4 text-xs font-medium tracking-wider text-left   uppercase   text-black">
                                                    Transaction
                                                </th>
                                                <th scope="col" className="p-4 text-xs font-medium tracking-wider text-left   uppercase   text-black">
                                                    Date & Time
                                        ...
                                        <tbody className="bg-white   ">
                                            <tr>
                                                <td className="p-4 text-sm font-normal   whitespace-nowrap   text-black">
                                                    Payment from <span className="font-semibold">Bonnie Green</span>
                                                </td>
                                                <td className="p-4 text-sm font-normal   whitespace-nowrap   400">
                                                    Apr 23 ,2021
                                                </td>
                                                <td className="p-4 text-sm font-semibold   whitespace-nowrap   text-black">
                                                    $2300
                                                </td>
                                                <td className="p-4 text-sm font-normal   whitespace-nowrap   400">
                                                    0047568936
                                                </td>
                                                <td className="inline-flex items-center p-4 space-x-2 text-sm font-normal   whitespace-nowrap   400">
                                                ...
                                                <td className="p-4 whitespace-nowrap">
                                                    <span
                                                        className="bg-green-100  text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md    text-green-400 border border-green-100  ">Completed</span>
                                                </td>
                                            </tr>
                                            <tr className=" 50  ">
                                                <td className="p-4 text-sm font-normal   whitespace-nowrap   text-black">
                                                ...
                                                <td className="p-4 whitespace-nowrap">
                                                    <span className="bg-green-100   text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md    text-green-400 border border-green-100   ">Completed</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-sm font-normal   whitespace-nowrap   text-black">
                                                ...
                                                <td className="p-4 whitespace-nowrap">
                                                    <span
                                                        className="bg-red-100   text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-red-100       text-red-400">Cancelled</span>
                                                </td>
                                            </tr>
                                            <tr className=" 50  ">
                                                <td className="p-4 text-sm font-normal   whitespace-nowrap   text-black">
                                                ...
                                                <td className="p-4 whitespace-nowrap">
                                                    <span className="bg-purple-100  text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-purple-100       text-purple-400">In progress</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="p-4 text-sm font-normal   whitespace-nowrap   text-black">
                                            ...
                                            <tr className=" 50  ">
                                                ...
                                                <td className="p-4 whitespace-nowrap">
                                                    <span className="bg-orange-100   text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-orange-100       text-orange-300">In review</span>
                                                </td>
                                            </tr>
                    ...
                    <div className="flex items-center justify-between pt-3 sm:pt-6">
                        <div>
                            <button className="inline-flex items-center p-2 text-sm font-medium text-center   rounded-lg     400  hover: text-black" type="button" data-dropdown-toggle="transactions-dropdown">Last 7 days <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></button>
                            
                            <div className="z-50 hidden my-4 text-base list-none bg-white divide-y  100 rounded shadow     " id="transactions-dropdown">
                                <div className="px-4 py-3" role="none">
                                    <p className="text-sm font-medium   truncate   text-black" role="none">
                                        Sep 16, 2021 - Sep 22, 2021
                                    </p>
