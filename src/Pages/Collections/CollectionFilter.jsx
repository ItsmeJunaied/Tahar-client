...
import { faAngleDown, faHeart, faSlash, faTimes, faX } from '@fortawesome/free-solid-svg-icons';
...
const CollectionFilter = ({ categoryWisedata, activeFabric, setActiveFabric, setFilteredProfuct }) => {
    ...
    const MaxMinPrice = categoryWisedata.map(item => item.price);
    ...
    const FindFabricsData = categoryWisedata.filter(item =>
        ChooseFabrics?.includes(item.fabrics)
    );

    //show selected color data
    const FindColordata = categoryWisedata.filter(item => {
        const colors = [
    ...
    const FindSizedata = categoryWisedata.filter(item => {
    ...
    const handleApply = () => {
        const FinalResult = categoryWisedata.filter(item => {
                                    ...
                                    {isOpenSize && (
                                        <>
                                            ...
                                            <div className='grid grid-cols-5 gap-3'>
                                                {categoryWisedata.some(item => parseInt(item.Squantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('S');
                                                            handleSize('S');
                                                ...
                                                {categoryWisedata.some(item => parseInt(item.Mquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('M');
                                                            handleSize('M');
                                                ...
                                                {categoryWisedata.some(item => parseInt(item.Lquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('L');
                                                            handleSize('L');
                                                ...
                                                {categoryWisedata.some(item => parseInt(item.XLquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('XL');
                                                            handleSize('XL');
                                                ...
                                                {categoryWisedata.some(item => parseInt(item.XXLquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('XXL');
                                                            handleSize('XXL');
                                                ...
                                                {categoryWisedata.some(item => parseInt(item.XXXLquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('XXXL');
                                                            handleSize('XXXL');
