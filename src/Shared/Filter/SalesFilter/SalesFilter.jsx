...
const SalesFilter = ({ ShopSale, activeFabric, setActiveFabric, setFilteredProfuct ,}) => {
    
    const { fabricsdata } = useContext(AuthContext);
    const [activeSize, setActiveSize] = useState('');
    const [activeID, setActiveID] = useState('');

    // console.log(ShopSale)
    ...
    const SColor = ShopSale?.map(item => item?.Scolor);
    const MColor = ShopSale?.map(item => item?.Mcolor);
    const LColor = ShopSale?.map(item => item?.Lcolor);
    const XLColor = ShopSale?.map(item => item?.XLcolor);
    const XXLColor = ShopSale?.map(item => item?.XXLcolor);
    const XXXLColor = ShopSale?.map(item => item?.XXXLcolor);
    ...
    const MaxMinPrice = ShopSale.map(item => item.price);
    ...
    const FindFabricsData = ShopSale.filter(item =>
        ChooseFabrics?.includes(item.fabrics)
    );

    //show selected color data
    const FindColordata = ShopSale.filter(item => {
        const colors = [
    ...
    const FindSizedata = ShopSale.filter(item => {
    ...
    const handleApply = () => {
        const FinalResult = ShopSale.filter(item => {
                                    ...
                                    {isOpenSize && (
                                        <>
                                            ...
                                            <div className='grid grid-cols-5 gap-3'>
                                                {ShopSale.some(item => parseInt(item.Squantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('S');
                                                            handleSize('S');
                                                ...
                                                {ShopSale.some(item => parseInt(item.Mquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('M');
                                                            handleSize('M');
                                                ...
                                                {ShopSale.some(item => parseInt(item.Lquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('L');
                                                            handleSize('L');
                                                ...
                                                {ShopSale.some(item => parseInt(item.XLquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('XL');
                                                            handleSize('XL');
                                                ...
                                                {ShopSale.some(item => parseInt(item.XXLquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('XXL');
                                                            handleSize('XXL');
                                                ...
                                                {ShopSale.some(item => parseInt(item.XXXLquantity) > 0) && (
                                                    <button
                                                        onClick={() => {
                                                            setActiveSize('XXXL');
                                                            handleSize('XXXL');
