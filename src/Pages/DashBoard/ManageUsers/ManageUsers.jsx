...
const ManageUsers = () => {
    ...
    const filteredUsers = loggedUser.filter(user => {
    ...
    const handleUserRole = (id, currentRole) => {
        ...
        fetch(`https://tahar-server-production.up.railway.app/users/${id}`, {
            method: "PATCH",
            headers: {
                        ...
                        <div className="overflow-x-auto">
                            <table className="table" ref={tableRef}>
                                ...
                                <tbody ref={tableRef}>
                                    {/* row 1 */}
                                    {
                                        filteredUsers === '' ? (loggedUser.map(customer =>
                                            <tr key={customer._id}>
                                                <td>
                                                    <div className="avatar">
                                                        <div className="mask mask-squircle w-12 h-12">
                                                            <img src={customer?.photoURL || userImg} alt="Avatar Tailwind CSS Component" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="flex items-center space-x-3">
                                                        ...
                                                        <div>
                                                            <div className="font-bold"><p className='text-black'>{customer?.firstName} {customer?.lastName} {customer?.name}</p></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <p className={`text-justify px-2 rounded-lg ${customer.role === 'Admin' ? 'bg-error' : 'bg-success'} w-fit`}>
                                                        {customer.role}
                                                    </p>
