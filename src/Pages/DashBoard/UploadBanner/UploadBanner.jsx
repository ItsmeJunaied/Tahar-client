...
const UploadBanner = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await fetch('https://taharecom-ayh8nwjc2-itsmejunaieds-projects.vercel.app/banner', {
                method: 'POST',
                body: formData,
            });
    ...
    const handleBannerDelete = async (id) => {
        ...
        fetch(`https://taharecom-ayh8nwjc2-itsmejunaieds-projects.vercel.app/banner/${id}`, {
            method: 'DELETE'
        })
            .then(res => res.json())
            .then(data => {
                                                            ...
                                                            <div className="flex items-center space-x-3">
                                                                <div className="avatar">
                                                                    <div className="mask mask-squircle w-12 h-12">
                                                                        <img src={`https://taharecom-ayh8nwjc2-itsmejunaieds-projects.vercel.app/uploads/${item.images}`} alt="banner img" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
