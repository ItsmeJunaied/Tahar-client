...
import SalesFilter from '../../Shared/Filter/SalesFilter/SalesFilter';
    ...
    return (
        <div className=' mb-20'>
            ...
            <div className=' mx-[70px] mt-10'>
                ...
                <SalesFilter activeFabric={activeFabric} setActiveFabric={setActiveFabric} ShopSale={ShopSale} setFilteredProfuct={setFilteredProfuct} ></SalesFilter>
                            ...
                            ShopSale && ShopSale.map(item =>
                                <div key={item._id} className=' w-[431px] h-fit '>
                                    ...
                                    <div className="flex flex-col justify-center align-middle items-center mt-2 gap-3">
                                        ...
                                        <div className="text-[#828282] text-[19px] [font-family:'Helvetica_Now_Display-Medium',Helvetica] mt-2 text-center">
                                            {item.Clearance === 'Sale' ? (
                                                <>
                                                    <span className="line-through">${parseInt(item.price)}</span> ${Math.round(parseInt(item.price) - (parseInt(item.price) * (parseInt(item?.sellpercet) / 100)))}
                                                </>
                                            ) : (
                                                `$${item.price}`
                                            )}
