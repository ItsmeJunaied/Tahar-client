                            ...
                            <div>
                                ...
                                <div className="z-50 hidden my-4 text-base list-none bg-white divide-y  100 rounded shadow     " id="weekly-sales-dropdown">
                                    ...
                                    <ul className="py-1" role="none">
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm     hover: text-black" role="menuitem">Yesterday</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm     hover: text-black" role="menuitem">Today</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm     hover: text-black" role="menuitem">Last 7 days</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm     hover: text-black" role="menuitem">Last 30 days</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 text-sm     hover: text-black" role="menuitem">Last 90 days</a>
                                        </li>
                                    </ul>
                                    <div className="py-1" role="none">
                                        <a href="#" className="block px-4 py-2 text-sm     hover: text-black" role="menuitem">Custom...</a>
                                    </div>
                                </div>
                            </div>
                            <div className="flex-shrink-0">
